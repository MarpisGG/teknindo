                ...
                <div className="w-full max-w-6xl">
                    <div className="mx-auto rounded-2xl bg-white p-10 text-justify text-lg leading-relaxed">
                        <p className="mb-6 text-gray-700">
                            At <span className="font-semibold text-[#FCC200]">Teknindo Group</span>, we provide comprehensive mining contractor
                            services that support the success of mining projects across Indonesia. Our team is equipped with deep industry experience
                            and operates with a focus on safety, efficiency, and productivity in every project we handle.
                        </p>
