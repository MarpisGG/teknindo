            ...
            <main className="flex flex-1 flex-col items-center px-4 py-4">
                <div className="w-full max-w-6xl">
                    <div className="mx-auto rounded-2xl bg-white p-10 text-justify text-lg leading-relaxed">
                        ...
                        <p className="mb-6 text-gray-700">
                            <span className="font-semibold text-[#FCC200]">Teknindo Group</span> provides a comprehensive range of mining
                            transportation solutions tailored to meet the demanding needs of the mining industry in Indonesia. Our fleet includes
                            heavy-duty trucks, excavators, shuttle buses for mining personnel, and other specialized vehicles designed to operate
                            reliably in tough and remote environments.
                        </p>
