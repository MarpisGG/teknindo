        ...
        <div className="mx-auto max-w-3xl px-4 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="web" value={formData.web} onChange={handleChange} className="w-full rounded border px-4 py-2" />
                    {errors.web && <div className="text-sm text-red-600">{errors.web}</div>}
                </div>
