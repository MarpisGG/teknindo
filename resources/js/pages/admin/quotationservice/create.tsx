...
const Create: React.FC = () => {
    ...
    const [data, setData] = useState<QuotationService>({
        id: 0,
        name: '',
    });
    ...
    const handleCancel = () => {
        window.location.href = '/admin/quotation-service';
    };
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        axios
            .post('/admin/quotation-services', formData)
            .then(() => {
                Swal.fire('Success', 'Quotation Service created successfully.', 'success');
                window.location.href = '/admin/quotation-services';
            })
            .catch((error) => {
        ...
        <div className="flex min-h-screen flex-col items-center bg-gray-100 px-4 py-10">
            <div className="w-full max-w-2xl p-6">
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800">Create Quotation Service</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex justify-start space-x-3 pt-4">
                        ...
                        >
                            {processing ? 'Creating...' : 'Create Quotation Service'}
                        </button>
                    </div>
                </form>
            </div>
