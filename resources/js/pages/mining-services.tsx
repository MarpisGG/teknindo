    ...
    return (
        <div className="flex min-h-screen flex-col bg-gray-50 dark:bg-[#0a0a0a]">
            ...
            <div className="flex min-h-screen flex-col items-center justify-center px-4 py-8">
                <h1 className="mb-8 text-center text-3xl font-bold text-gray-900 dark:text-white">Mining Services </h1>
            </div>
                ...
                <div className="w-full max-w-6xl">
                    <div className="mx-auto rounded-2xl bg-white p-10 text-justify text-lg leading-relaxed dark:text-neutral-300">
                        <p className="mb-6 text-gray-700 dark:text-gray-300">
                            <span className="font-semibold text-[#FCC200] dark:text-yellow-400">Teknindo Group</span> offers a wide range of mining
                            services to support the diverse operational needs of mining companies across Indonesia. Our services are designed to help
                            you optimize efficiency, reduce costs, and maximize productivity at every stage of your mining operation.
                        </p>
                        ...
                        <p className="text-gray-700 dark:text-gray-300">
                            Partner with <span className="font-semibold text-[#FCC200] dark:text-yellow-400">Teknindo Group</span> for trusted mining
                            services that deliver measurable value and long-term success to your business.
                        </p>
                    </div>
                </div>
            </main>
